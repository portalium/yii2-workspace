...
class m010101_010102_workspace_menu extends Migration
{
    ...
    public function up()
    {
        ...
        $this->batchInsert('menu_item', ['id_item', 'label', 'slug', 'type', 'style', 'data', 'sort', 'id_menu', 'name_auth', 'id_user', 'date_create', 'date_update'], [
            ...
            [NULL, 'Workspaces', 'workspace-workspaces', '2', '{"icon":"","color":"","iconSize":"","display":"","childDisplay":false}', '{"data":{"module":"workspace","routeType":"action","route":"\\/workspace\\/default\\/manage","model":null,"menuRoute":null,"menuType":"web"}}', '13', $id_menu, 'workspaceWebDefaultIndex', 1, '2022-06-13 15:32:26', '2022-06-13 15:32:26']
        ]);
